# 1 "/home/ec2-user/FPGA_go_brrrr/practice/wide_vmult/kernel/kernel.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/ec2-user/FPGA_go_brrrr/practice/wide_vmult/kernel/kernel.cpp" 2


extern "C"{
    __attribute__((sdx_kernel("wide_krnl", 0))) void wide_krnl(
        float* a,
        float* b,
        float* out,
        unsigned int num_elements
    ){
#pragma HLS TOP name=wide_krnl
# 9 "/home/ec2-user/FPGA_go_brrrr/practice/wide_vmult/kernel/kernel.cpp"
