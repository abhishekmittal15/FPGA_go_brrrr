...
open_project wide_krnl
set_top wide_krnl
# v++ -g, -D, -I, --advanced.prop kernel.wide_krnl.kernel_flags
add_files "/home/ec2-user/FPGA_go_brrrr/practice/wide_vmult/kernel/kernel.cpp" -cflags " -g -I /home/ec2-user/FPGA_go_brrrr/practice/wide_vmult/include "
...
config_export -format ip_catalog -ipname wide_krnl
